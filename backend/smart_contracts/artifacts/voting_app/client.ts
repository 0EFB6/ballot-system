...
export abstract class VotingAppCallFactory {
  ...
  static get create() {
    return {
      /**
       * Constructs a create call for the voting_app smart contract using a bare call
       *
...
/**
 * A client to make calls to the voting_app smart contract
 */
export class VotingAppClient {
  ...
  /**
   * Idempotently deploys the voting_app smart contract.
   *
  ...
  public get create() {
    ...
    return {
      /**
       * Creates a new instance of the voting_app smart contract using a bare call.
       *
  ...
  /**
   * Makes a clear_state call to an existing instance of the voting_app smart contract.
   *
   * @param args The arguments for the bare call
